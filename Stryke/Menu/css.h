...
public:
	void SetThemeColor(ImVec4 to) { this->themeCol = to; }
	void SetThemeHovered(ImVec4 to) { this->themeHov = to; }
	void SetThemeActive(ImVec4 to) { this->themeAct = to; }

	void SetTextColor(ImVec4 to) { this->textCol = to; }
	void SetTextActive(ImVec4 to) { this->textAct = to; }
private:
	float opacity = 1.f;
public:
