...
void ClickGui::RenderSettings() {
	...
	style->Colors[ImGuiCol_ChildBg] = ImVec4(0.0f, 0.0f, 0.0f, 0.0784313753247261f);
	...
	style->Colors[ImGuiCol_FrameBgHovered] = ImVec4(0.196078434586525f, 0.3921568691730499f, 0.5882353186607361f, 0.7843137383460999f);
	style->Colors[ImGuiCol_FrameBgActive] = ImVec4(0.2588235437870026f, 0.5882353186607361f, 0.9764705896377563f, 0.7843137383460999f);
